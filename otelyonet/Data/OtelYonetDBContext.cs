...
namespace otelyonet.Data
{
    public class OtelYonetDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //                                    new Rezervasyon {RezervasyonID = 1,MüşteriID = 1 ,OdaID = 1,ÖdemeTipiID = 2,BasTarih =Convert.ToDateTime("01/01/2021"),BitTarih = Convert.ToDateTime("04/01/2021"),RezervasyonTarihi = Convert.ToDateTime("01/12/2020"), YetişkinSayısı = 1, ÇocukSayısı = 0,BebekSayısı =0,RezervOdaFiyatı = 100},
            //                                    new Rezervasyon {RezervasyonID = 2,MüşteriID = 2 ,OdaID = 2,ÖdemeTipiID = 1,BasTarih =Convert.ToDateTime("01/02/2021"),BitTarih = Convert.ToDateTime("04/02/2021"),RezervasyonTarihi = Convert.ToDateTime("01/01/2021"), YetişkinSayısı = 2, ÇocukSayısı = 1,BebekSayısı =0,RezervOdaFiyatı = 200},
            //                                    new Rezervasyon {RezervasyonID = 3,MüşteriID = 3 ,OdaID = 3,ÖdemeTipiID = 2,BasTarih =Convert.ToDateTime("01/03/2021"),BitTarih = Convert.ToDateTime("04/03/2021"),RezervasyonTarihi = Convert.ToDateTime("01/02/2021"), YetişkinSayısı = 2, ÇocukSayısı = 2,BebekSayısı =3,RezervOdaFiyatı = 400}
