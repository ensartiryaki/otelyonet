        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YetişkinSayısı = table.Column<int>(type: "int", nullable: false),
                    ÇocukSayısı = table.Column<int>(type: "int", nullable: false),
                    BebekSayısı = table.Column<int>(type: "int", nullable: false),
                    RezervOdaFiyatı = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    RezervasyonTarihi = table.Column<DateTime>(type: "Date", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "RezervasyonID", "BasTarih", "BebekSayısı", "BitTarih", "MüşteriID", "OdaID", "RezervOdaFiyatı", "RezervasyonTarihi", "YetişkinSayısı", "ÇocukSayısı", "ÖdemeTipiID" },
                values: new object[] { 1, new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, new DateTime(2021, 1, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, 100m, new DateTime(2020, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 0, 2 });

            migrationBuilder.InsertData(
                table: "Rezervasyonlar",
                columns: new[] { "RezervasyonID", "BasTarih", "BebekSayısı", "BitTarih", "MüşteriID", "OdaID", "RezervOdaFiyatı", "RezervasyonTarihi", "YetişkinSayısı", "ÇocukSayısı", "ÖdemeTipiID" },
                values: new object[] { 2, new DateTime(2021, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, new DateTime(2021, 2, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 2, 200m, new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 1, 1 });

            migrationBuilder.InsertData(
                table: "Rezervasyonlar",
                columns: new[] { "RezervasyonID", "BasTarih", "BebekSayısı", "BitTarih", "MüşteriID", "OdaID", "RezervOdaFiyatı", "RezervasyonTarihi", "YetişkinSayısı", "ÇocukSayısı", "ÖdemeTipiID" },
                values: new object[] { 3, new DateTime(2021, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, new DateTime(2021, 3, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, 3, 400m, new DateTime(2021, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 2, 2 });
